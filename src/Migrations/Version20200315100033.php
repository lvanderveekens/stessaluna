 ...
 */
final class Version20200315100033 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE aorb_post_sentence (id INT AUTO_INCREMENT NOT NULL, post_id INT NOT NULL, text_before VARCHAR(255) NOT NULL, choice_a VARCHAR(255) NOT NULL, choice_b VARCHAR(255) NOT NULL, text_after VARCHAR(255) NOT NULL, INDEX IDX_34FB49B24B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
