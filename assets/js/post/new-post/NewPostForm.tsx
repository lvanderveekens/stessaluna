...
const NewPostForm: FC<Props> = ({ user, createPost }) => {
  ...
  const [showChooseExercise, setShowChooseExercise] = useState(false);
      ...
      {showChooseExercise
        ? (
          <div className={styles.chooseExercise}>
            <div className={styles.header}><div className={styles.deleteButton} onClick={() => setShowChooseExercise(false)}>X</div></div>
            <div className={styles.exerciseOption}>A or B</div>
          </div>
        ) : (
          <Formik
              ...
              <Form className={styles.newPostForm} noValidate onSubmit={handleSubmit}>
                <div className={styles.inputBox}>
                  ...
                  <div className={styles.attachments}>
                    ...
                    <span onClick={handleExerciseClick}><FontAwesomeIcon icon={faGraduationCap} />Exercise</span>
                  </div>
                </div>
